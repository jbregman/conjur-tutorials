...
echo $secret_access_key | conjur variable values add aws/$1/SecretAccessKey
echo $session_token | conjur variable values add aws/$1/SessionToken
echo $access_key_id | conjur variable values add aws/$1/AccessKeyId
